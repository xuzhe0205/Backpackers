...
public class CustomerLoginJPanel extends javax.swing.JPanel {
    ...
    public CustomerLoginJPanel(JPanel upc, EcoSystem sys) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UserInterface/AdministrativeRole/denglumima-baise.png"))); // NOI18N

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UserInterface/AdministrativeRole/64guanliyuan.png"))); // NOI18N
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addComponent(logoutJButton, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btnSignupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSignupActionPerformed
        ...
        CreateCustomerJPanel customerSignupJP=new CreateCustomerJPanel(userProcessContainer, system);
        userProcessContainer.add("CustomerSignupJPanel",customerSignupJP);
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        for(Network network:system.getNetworkList()){
            ...
            for(Enterprise enterprise:network.getEnterpriseDirectory().getEnterpriseList()){
                if (enterprise.getEnterpriseType().getValue().equals(enterpriseType)){
                    //System.out.println("Current enterprise type: " + enterprise.getEnterpriseType().getValue()+",   "+enterpriseType);
                    ...
                    if(userAccount==null){
                        ...
                        for(Organization organization:enterprise.getOrganizationDirectory().getOrganizationList()){
                            ...
                            if (organization.getName().equals("Customer Organization")){
                                //System.out.println("Customer Organization useraccount count: " + organization.getUserAccountDirectory().getUserAccountList().size());
        ...
        if(userAccount==null){
            ...
            CustomerDirectionJPanel customerDirectionJPanel = new CustomerDirectionJPanel(userProcessContainer, userAccount, inOrganization, system);
            userProcessContainer.add("CustomerDirectionJPanel",customerDirectionJPanel);
            CardLayout layout=(CardLayout)userProcessContainer.getLayout();
